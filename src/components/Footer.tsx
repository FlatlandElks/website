...
export const FooterDiv = tailt.footer`
...
export const FooterTitleBox = tailt.div`flex flex-col w-full gap-y-3`
export const FooterMainTitle = tailt.h3`font-bold text-4xl`
export const FooterSubTitle = tailt.h3`gap-x-6 font-semibold text-lg`
